...
```{r, warning=, message=FALSE}
  ...
  gridExtra::grid.arrange(plot_incidence_ests_report(conf_cases=jhucsse, incid_ests=incidence_data, locations="Hubei") + ggtitle("Uncorrected"),
                          plot_incidence_ests_report(conf_cases=jhucsse, incid_ests=corrected_hubei, locations="Hubei") + ggtitle("Corrected for Feb 13"),
                          plot_incidence_ests_report(conf_cases=jhucsse, incid_ests=corrected_hubei_1314, locations="Hubei") + ggtitle("Corrected for Feb 13-14"), nrow=3)
