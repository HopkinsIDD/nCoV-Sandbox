...
Data is setup with three scenarios in turn assuming that 5%, 10% and 25% of
...
We then find the optimal $\theta$ that best make this assumed data
consistent with several values of $R_0$.
